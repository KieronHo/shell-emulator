...
extern int	execute_shellcmd(SHELLCMD *, int exitstatus);	// in execute.c
...
extern  int   child_pids[]; //Array to store child pids that are till active
...
//include all new created programs
extern  void change_path_argument(SHELLCMD *t, char *path_test_string, int argument_to_test);
extern int run_subshell(SHELLCMD *t, int exitstatus);
extern int print_redirection(SHELLCMD *t, int exitstatus);
extern int command(SHELLCMD *t, int exitstatus);
extern int pipe_redirection(SHELLCMD *t, int exitstatus);
extern void run_shellscript(SHELLCMD *t, int exitstatus);
extern int background_execution(SHELLCMD *first_command, SHELLCMD *second_command, int exitstatus);
